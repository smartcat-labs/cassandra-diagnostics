 ...
 */
public class Connector21QueryReporter extends AbstractEventProcessor {

    private static final Logger logger = LoggerFactory.getLogger(Connector21QueryReporter.class);
     ...
     */
    public Connector21QueryReporter(QueryReporter queryReporter, ConnectorConfiguration configuration) {
