...
CLASSPATH="/cassandra-diagnostics/cassandra-diagnostics-connector.jar:/cassandra-diagnostics/cassandra-diagnostics-reporter-influx.jar:/cassandra-diagnostics/influxdb-java.jar:$CLASSPATH"
