...
public class DiagnosticsAgent {
    ...
    private static void setIntercepters(String args, Instrumentation inst) {
        System.out.println(
                "Cassandra Diagnostics Agenet: injecting org.apache.cassandra.cql3.QueryProcessor interceptor");
        ...
        new AgentBuilder.Default().with(byteBuddy).with(AgentBuilder.InitializationStrategy.Minimal.INSTANCE)
                ...
                .type(type)
                .transform((builder, typeDescription, classloader) -> builder.method(named("processStatement"))
